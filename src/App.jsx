...
      content: {
        heading: "Вы атрымалі ліст з рашэннем Адборачнай камісіі",
...
        actions: [
          "Уважліва прачытайце ліст з рашэннем Адборачнай камісіі",
          "Звярніце ўвагу на пералік заўваг да натарыву і/ці бюджэту праекта.",
          "Адзначце для сябе моманты, якія патрабуюць дадатковых тлумачэнняў.",
          "Чакайце ад вашага грант-меннджара/кі прапановы кароткай сустрэчу ў Zoom ці ліста з падрабязнымі заўвагамі. Падчас размовы будзе прастора на абмеркаванне заўваг, тлумачэнне растлумачым логіку змяненняў і абмяркуем наступныя крокі." 
        ],
